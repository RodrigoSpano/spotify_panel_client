...
const ArtistCard = ({artist, position}) => {
  return (
    <motion.div whileHover={{scale: 1.1}} className='flex gap-3 transition-all ease-linear duration-250 items-center justify-start cursor-pointer h-[60px] w-full rounded-md hover:bg-background/10 px-2'>
