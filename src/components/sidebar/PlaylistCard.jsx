...
const PlaylistCard = ({list}) => {
  ...
  return (
    <m.div onClick={onOpen} whileInView={{opacity: [0,1], transition:{duration: 0.5, delay: 0.2}}} className='select-none flex gap-4 items-center justify-start hover:bg-background/10 cursor-pointer p-2 rounded-md'>
